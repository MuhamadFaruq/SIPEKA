...
class _BudgetScreenState extends State<BudgetScreen> {
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  RunRow(isEditing, mainContext, budget, saveProcess, startBlue),
                ],
              ),
            );
          }
  ...
  Widget RunRow(bool isEditing, BuildContext mainContext, Budget? budget, VoidCallback saveProcess, Color startBlue) {
    return Row(
      children: [
  ...
  List<Transaction> _filterTransactionsByMonth(List<Transaction> allTx) {
    ...
    return allTx.where((tx) => tx.date.month == now.month && tx.date.year == now.year && (tx.type == TransactionType.expense)).toList();
  }
